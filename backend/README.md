...
## Project Structure
    ...
    ├── testapiautosetting_123012  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123012`
...
2. Clone this repo and `cd testapiautosetting_123012`
